          ...
          <table role="presentation" style="width:94%;max-width:600px;border:none;border-spacing:0;text-align:left;font-family:Arial,sans-serif;font-size:16px;line-height:22px;color:#363636;">
            ...
            <tr>
              <td style="padding:30px 30px 15px 30px;background-color:#ffffff;">
                ...
                <p style="margin-top:0;margin-bottom:18px;">Hallo ${name},<br/>wir haben gehört, dass du dein Passwort vergessen hast. Kein Grund zur Sorge! Du kannst den folgenden Button benutzen, um dein Passwort zurückzusetzen. Wenn du das nicht warst, kannst du diese Nachricht einfach ignorieren.</p>
