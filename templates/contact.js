...
module.exports = contactMail = (subject, message) => {
    return `<!DOCTYPE html>
...
<body style="margin:0;padding:0;word-spacing:normal;background-color:#dddddddddddd;">
  <div role="article" aria-roledescription="email" lang="en" style="text-size-adjust:100%;-webkit-text-size-adjust:100%;-ms-text-size-adjust:100%;background-color:#dddddddddddd;">
          ...
          <table role="presentation" style="width:94%;max-width:600px;border:none;border-spacing:0;text-align:left;font-family:Arial,sans-serif;font-size:16px;line-height:22px;color:#363636;">
            ...
            <tr>
              <td style="padding:30px 30px 15px 30px;background-color:#ffffff;">
                <h1 style="margin-top:0;margin-bottom:18px;font-size:26px;line-height:32px;font-weight:bold;letter-spacing:-0.02em;">Kontaktanfrage</h1>
                <p style="margin-top:0;margin-bottom:0px;">Hallo,<br/>vielen Dank für deine Nachricht. Wir kümmern uns so schnell wie möglich um dein Anliegen.</p>
              </td>
            </tr>
            <tr>
              <td style="padding:0px 30px 11px 30px;font-size:0;background-color:#ffffff;border-bottom:1px solid #f0f0f5;border-color:rgba(201,201,207,.35);">
                ...
                <div class="col-lge" style="display:inline-block;width:100%;max-width:395px;vertical-align:top;padding-bottom:20px; font-family:Arial,sans-serif;font-size:16px;line-height:22px;color:#363636;">
                  <div style="margin-top:0;margin-bottom:18px; padding: 5px; border: 1px solid #f3ac8b">
                    <div>Betreff:<br/>${subject}</div>
                    <div style="margin-top: 8px;">Nachricht:<br/>${message}</div>
                  </div>
                  <p style="margin-top:18px;margin-bottom:10px;">Viel Spaß beim Kochen!</p>
                </div>
                <!--[if mso]>
                </td>
