...
module.exports = unauthorizedUser = (name) => {
    return `<!DOCTYPE html>
...
<head>
  ...
  <title>Nutzerkonto nicht authorisiert</title>
  <!--[if mso]>
  <style>
          ...
          <table role="presentation" style="width:94%;max-width:600px;border:none;border-spacing:0;text-align:left;font-family:Arial,sans-serif;font-size:16px;line-height:22px;color:#363636;">
            ...
            <tr>
              <td style="padding:30px 30px 15px 30px;background-color:#ffffff;">
                <h1 style="margin-top:0;margin-bottom:18px;font-size:26px;line-height:32px;font-weight:bold;letter-spacing:-0.02em;">Authorisierung abgelehnt</h1>
                <p style="margin-top:0;margin-bottom:0px;">Hallo ${name},<br/>der Admin hat dich auf Basis deiner angegebenen Daten leider nicht authorisieren können. Deine Registrierung ist damit fehlgeschlagen. Weitere Informationen erhälst du unter <a href="${url}/faq" style="text-decoration:none;color:#e85917;">FAQ</a>.</p>
              </td>
            </tr>
            <tr>
